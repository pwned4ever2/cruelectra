...
echo "Electra uninstaller  by Pwned4ever2for Electra 1.0.x forked from KirovAir"
...
echo "Removing and Fucking Cydia bootstrap.. "
...
# electra bootstrap
echo "Removing and Fucking electra bootstrap.."
rm -rf /electra/
...
# Topanga
echo "Removing possible topanga junk (just making sure)"
rm -f /bin/bzip2_64
rm -f /bin/hostname
...
echo "All jailbreak related files are removed! (all included in the iOS 11 electra JB)"
echo "Rebooting... (don't panic!)"
kill 1
